...
namespace LiftMeUp2.Controllers
{
    public class StationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("stationId,stationName,isAccesible,hasElevator")] Station station)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("stationId,stationName,isAccesible,hasElevator")] Station station)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LiftMeUp2Context.Station'  is null.");
            }
            var station = await _context.Station.FindAsync(id);
            if (station != null)
            {
